...
function imgui.project()
	project "imgui"
		...
		files {
			...
			path.join(imgui.source, "backends/imgui_impl_opengl3.cpp"),
            path.join(imgui.source, "backends/imgui_impl_opengl3.h"),
			path.join(imgui.source, "backends/imgui_impl_opengl3_loader.h"),
