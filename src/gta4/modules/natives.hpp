#pragma once
#include "gta4/game/game.hpp"

// Code taken from FusionFix :
// https://github.com/ThirteenAG/GTAIV.EFLC.FusionFix/blob/5458979450daa510b324a3aaadc2092ad5e0104b/source/natives.ixx
// https://github.com/ThirteenAG/GTAIV.EFLC.FusionFix/blob/5458979450daa510b324a3aaadc2092ad5e0104b/license

namespace gta4
{
	class natives final : public shared::common::loader::component_module
	{
	public:
		natives();
		~natives() = default;
	
		static inline natives* p_this = nullptr;
		static natives* get() { return p_this; }
		...
		protected:
			...
			uint32_t m_nArgCount = 0u;
			void* m_pArgs = nullptr;
			uint32_t m_nDataCount = 0u;
			Vector* m_pOriginalData[4] = {};
			Vector4D  m_TemporaryData[4] = {};
		...
		public:
			...
			T GetResult(int idx)
			{
				...
				{
					m_nDataCount--;
					Vector* pVec3 = m_pOriginalData[m_nDataCount];
					Vector4D* pVec4 = &m_TemporaryData[m_nDataCount];
					pVec3->x = pVec4->x;
					pVec3->y = pVec4->y;
					pVec3->z = pVec4->z;
				}
		...
		public:
			...
			{
				if (game::getNativeAddress){
					return reinterpret_cast<ncall>(game::getNativeAddress(Hash));
				}

				auto ms_pNatives = *game::ms_pNatives;
				auto ms_dwNativeTableSize = *game::ms_dwNativeTableSize;
		...
		public:
			...
			static R Invoke(Args... args)
			{
				...
				if (game::m_CodePause && !*game::m_CodePause)
				{
					if (!m_IndexTable[Index])
					{
						if (const auto fn = GetNativeHandler(Hash); fn) 
						{
	...
	public:
		...
		static inline auto AddPointToGpsRaceTrack(Vector* point) { return NativeInvoke::Invoke<59, std::to_underlying(NativeHashes::ADD_POINT_TO_GPS_RACE_TRACK), void>(point); }
		...
		static inline auto GenerateDirections(float x, float y, float z, int32_t* direction, Vector* a5) { return NativeInvoke::Invoke<615, std::to_underlying(NativeHashes::GENERATE_DIRECTIONS), void>(x, y, z, direction, a5); }
		...
		static inline auto GetBlipCoords(Blip blip, Vector* pVector) { return NativeInvoke::Invoke<633, std::to_underlying(NativeHashes::GET_BLIP_COORDS), void>(blip, pVector); }
		...
		static inline auto GetCarDeformationAtPos(Vehicle vehicle, float x, float y, float z, Vector* pDeformation) { return NativeInvoke::Invoke<660, std::to_underlying(NativeHashes::GET_CAR_DEFORMATION_AT_POS), void>(vehicle, x, y, z, pDeformation); }
		...
		static inline auto GetCarForwardVector(Car car, Vector* vec) { return NativeInvoke::Invoke<662, std::to_underlying(NativeHashes::GET_CAR_FORWARD_VECTOR), void>(car, vec); }
		...
		static inline auto GetCarSpeedVector(Vehicle vehicle, Vector* pVector, bool unknownFalse) { return NativeInvoke::Invoke<676, std::to_underlying(NativeHashes::GET_CAR_SPEED_VECTOR), void>(vehicle, pVector, unknownFalse); }
		...
		static inline auto GetClosestRoad(float x, float y, float z, float a4, int a5, Vector* a6, Vector* a7, float* a8, float* a9, float* a10) { return NativeInvoke::Invoke<725, std::to_underlying(NativeHashes::GET_CLOSEST_ROAD), bool>(x, y, z, a4, a5, a6, a7, a8, a9, a10); }
		...
		static inline auto GetCutscenePedPosition(int32_t unkped, Vector* pos) { return NativeInvoke::Invoke<754, std::to_underlying(NativeHashes::GET_CUTSCENE_PED_POSITION), void>(unkped, pos); }
		...
		static inline auto GetModelDimensions(uint32_t model, Vector* pMinVector, Vector* pMaxVector) { return NativeInvoke::Invoke<858, std::to_underlying(NativeHashes::GET_MODEL_DIMENSIONS), void>(model, pMinVector, pMaxVector); }
		...
		static inline auto GetNthClosestWaterNodeWithHeading(float x, float y, float z, bool flag0, bool flag1, Vector* node, float* heading) { return NativeInvoke::Invoke<893, std::to_underlying(NativeHashes::GET_NTH_CLOSEST_WATER_NODE_WITH_HEADING), bool>(x, y, z, flag0, flag1, node, heading); }
		...
		static inline auto GetOffsetsForAttachCarToCar(Car car0, Car car1, Vector* a3, Vector* a4) { return NativeInvoke::Invoke<938, std::to_underlying(NativeHashes::GET_OFFSETS_FOR_ATTACH_CAR_TO_CAR), void>(car0, car1, a3, a4); }
		...
		static inline auto GetPedBonePosition(Ped ped, uint32_t bone, float x, float y, float z, Vector* pPosition) { return NativeInvoke::Invoke<947, std::to_underlying(NativeHashes::GET_PED_BONE_POSITION), void>(ped, bone, x, y, z, pPosition); }
		...
		static inline auto GetVehicleComponentInfo(Vehicle veh, int32_t component_id, Vector* a3, Vector* a4, int32_t* a5, bool flag) { return NativeInvoke::Invoke<1077, std::to_underlying(NativeHashes::GET_VEHICLE_COMPONENT_INFO), bool>(veh, component_id, a3, a4, a5, flag); }
		...
		static inline auto GetViewportPositionOfCoord(float x, float y, float z, int32_t vpindex, float* vx, float* vy) { return NativeInvoke::Invoke<1087, std::to_underlying(NativeHashes::GET_VIEWPORT_POSITION_OF_COORD), bool>(x, y, z, vpindex, vx, vy); }
		...
		static inline auto LookAtNearbyEntityWithSpecialAttribute(int a1, Vector* a2, float* a3, Any* a4, Any* a5, Any* a6) { return NativeInvoke::Invoke<1533, std::to_underlying(NativeHashes::LOOK_AT_NEARBY_ENTITY_WITH_SPECIAL_ATTRIBUTE), bool>(a1, a2, a3, a4, a5, a6); }
